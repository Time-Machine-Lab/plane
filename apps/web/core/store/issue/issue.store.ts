...
export type IIssueStore = {
  ...
  getIssuesByIds(issueIds: string[], type: "all" | "archived" | "un-archived"): TIssue[]; // Record defines issue_id as key and TIssue as value
};
...
export class IssueStore implements IIssueStore {
   ...
   */
  getIssuesByIds = computedFn((issueIds: string[], type: "all" | "archived" | "un-archived") => {
