...
Define Canvas blocks in Plane Pages, including insertion, preview and editing, safe persistence, collaboration awareness, lifecycle preservation, export, validation, and accessibility.
