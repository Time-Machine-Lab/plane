...
Define how the Plane Codex Skill is installed, validates a Plane connection, safely registers the Plane MCP endpoint, reports readiness, and diagnoses connection failures.
