...
Define the core Plane Codex Skill guidance for selecting MCP tools, checking connection status, containing credentials, and separating vendor, team, and project-specific rules.
